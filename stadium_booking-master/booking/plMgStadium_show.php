        ...
        <div class="post-body">
            <div class="entry-header">
                <h2 class="entry-title">
                    <a href="javascript:void(0)">จัดการการจอง <span style="color: red"></span></a>
                </h2>
            </div><!-- header end -->
                ...
                <table id="mgBook_table" class="table  table-borderless " style="width:100%">
                    ...
                    <tbody>
                        ...
                        $sql_search = "SELECT *,
                                        ...
                                        FROM `reserv_stadium` as rt INNER JOIN stadium as st ON st.id_stadium  = rt.id_stadium  WHERE rt.id_cm  = '$ID_USER' AND (rt.status_reserv != 2 AND rt.status_reserv != 3);";
                        $i_r = null;
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    echo $row->status_reserv == 0 ? "<span class='badge badge-warning'>รอยืนยัน</span>" : "<span class='badge badge-primary'>ยืนยันแล้ว</span>";
                                    ?>

                                </td>
                                <td><a href="javascript:cancel_re(<?php echo $row->id_reserv ; ?>)" class="badge badge-danger">ยกเลิก</a></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
